...
# roach
kubectl exec --stdin --tty roach -- cockroach init --certs-dir=/certs/node-1 --host=roach-1:26357
kubectl exec --stdin --tty roach -- cockroach sql --certs-dir=/certs/node-1 --host=roach-1:26257 < ../../stack/roach/init.sql
